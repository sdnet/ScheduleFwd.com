...
?>
    <div id="adminLeftLinks" style="text-align: center; float: left; width: 98%; margin: 0 auto;">
        ...
        <a href="mySchedule" title="Generate and View Schedules">Schedules</a> | 
        ...
        <a href="groupsAndRoles" title="Create and Edit User Roles and Groups">Sites, Groups and Roles</a> | 
        <a href="rules" title="View and Configure System Rules">Configurations</a> | 
	<a href="docs/AdminGuide.pdf" target="_new" title="User Administration Document">Admin Guide</a>
    </div>
...
?>
    <div id="adminLeftLinksUser" style="float: left;">
    	<a href="home" title="View Your Dashboard">Dashboard</a> |
        <a href="mySchedule" title="View Your Schedule">View Your Schedule</a> | 
