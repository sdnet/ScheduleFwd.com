                           ...
                           <tr id=\"tblShiftTradeDays\"><td width=42>M</td><td width=42>T</td><td 
                                     ...
                                     while ( $day_num <= $days_in_month ) {
										...
										foreach ($shiftArray[$day_num] as $shift) {
											...
											$grayedOutShift = $htmlBody."<div id=\"\" style=\"padding: 3px; font-size:1.0em;\"><strong>".$shift['shiftName']. "</strong> <span style=\"font-size:1.0em;\">(".$startTime."-".$endTime.")</span><br><span style=\"font-size:1.0em;\">";
										
										
											$notGrayedOutShift = $htmlBody."<div id=\"\" style=\"padding: 3px; color:#CCCCCC; font-size:1.0em;\"><strong>".$shift['shiftName']. "</strong> <span style=\"font-size:1.0em;\">(".$startTime."-".$endTime.")</span><br><span style=\"font-size:1.0em;\">";
											
											$includedUser = False;
											
											
											foreach($shift['users'] as $user) {
												if($user['id'] == $passedInUser) {
												
													$includedUser = True;
													
													
													$grayedOutShift = $grayedOutShift.$user['first_name']." ".$user['last_name']."<br>";
												}
												else {
													$notGrayedOutShift = $notGrayedOutShift."<span style=\"color:#CCCCCC;\">".$user['first_name']." ".$user['last_name']."</span><br>";
													$grayedOutShift = $grayedOutShift."<span style=\"color:#CCCCCC;\">".$user['first_name']." ".$user['last_name']."</span><br>";
												}
												
											}
											
											if($includedUser) {
												$htmlBody = $grayedOutShift;
											}
											else {
												$htmlBody = $notGrayedOutShift;
											}
